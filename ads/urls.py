...
from .views import AdListView, AdCreateView, AdDetailView, CommentListView, CommentDetailView
...
urlpatterns = [
    ...
    path('ads/<int:ad_id>/comments/<int:pk>/', CommentDetailView.as_view(), name='comment-detail'),
]
